...
for EFPS = EFPS_SET
    for DFPS = EFPS %DFPS_SET
        ...
        save(['F:\IFEFSR\Recognition analysis\tactic3_GMM_' num2str(floor(EFPS/1000)) 'to' ...
            num2str(floor(DFPS/1000)) DATA_SET MFCC_PARAMS_STR '_' SUBBAND 'BAND'],'GMM');
        save(['F:\IFEFSR\Recognition analysis\tactic3_MODEL_' num2str(floor(EFPS/1000)) 'to' ...
            num2str(floor(DFPS/1000)) DATA_SET MFCC_PARAMS_STR '_' SUBBAND 'BAND'],'MODEL');
        save(['F:\IFEFSR\Recognition analysis\tactic3_TRAIN' num2str(floor(EFPS/1000)) 'to' ...
            num2str(floor(DFPS/1000)) DATA_SET MFCC_PARAMS_STR '_' SUBBAND 'BAND']);
    end
end
